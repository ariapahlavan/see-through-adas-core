...
if __name__ == "__main__":
    ...
    offset = (40, -30)
    img_mask = io.imread('maskOfFront.png', as_grey=True)
    img_src = io.imread('back.jpg').astype(np.float64)
    img_target = io.imread('back.jpg')

    ShowImgAndCloseWhen(img_mask)
