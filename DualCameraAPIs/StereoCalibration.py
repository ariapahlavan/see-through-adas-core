...
if input("Recapture chessboard images? (\'y\')") == "y":
    ...
    dualCam = DualLensStream(cam1=cam1, cam2=cam2, resolution=CAMERA_RESOLUTION)
...
dualCam = DualLensStream(cam1=cam1, cam2=cam2, framerate=30, resolution=CAMERA_RESOLUTION)
